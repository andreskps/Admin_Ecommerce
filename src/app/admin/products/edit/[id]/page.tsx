...
export default async function EditProductPage({ params }: Props) {
  ...
  const [categories, brands, pets, product, discounts,providers] = await Promise.all([
  ...
  return <FormCreateProduct product={product} categories={categories} brands={brands} pets={pets} discounts={discounts} providers={providers}/>;
}